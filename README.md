...
<head>
    ...
    <!--====== Favicon Icon ======-->
    <link rel="shortcut icon" href="assetsdemo/images/favicon.png" type="image/png">
        
    <!--====== Animate CSS ======-->
    <link rel="stylesheet" href="assetsdemo/css/animate.css">
        
    <!--====== Magnific Popup CSS ======-->
    <link rel="stylesheet" href="assetsdemo/css/magnific-popup.css">
        
    <!--====== Slick CSS ======-->
    <link rel="stylesheet" href="assetsdemo/css/slick.css">
        
    <!--====== Line Icons CSS ======-->
    <link rel="stylesheet" href="assetsdemo/css/LineIcons.css">
        
    <!--====== Font Awesome CSS ======-->
    <link rel="stylesheet" href="assetsdemo/css/font-awesome.min.css">
        
    <!--====== Bootstrap CSS ======-->
    <link rel="stylesheet" href="assetsdemo/css/bootstrap.min.css">
    
    <!--====== Default CSS ======-->
    <link rel="stylesheet" href="assetsdemo/css/default.css">
...
<body>
  ...
  <![endif]-->    
    ...
    <header class="header-area">
                    ...
                    <div class="col-lg-12">
                        <nav class="navbar navbar-expand-lg">
                            <a class="navbar-brand" href="index.html">
                                <img src="assetsdemo/images/logo.svg" alt="Logo">
                            </a>
        ...
        <div id="home" class="header-hero bg_cover" style="background-image: url(assetsdemo/images/banner-bg.svg)">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="header-hero-image text-center wow fadeIn" data-wow-duration="1.3s" data-wow-delay="1.4s">
                            <img src="assetsdemo/images/header-hero.png" alt="hero">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="section-title text-center pb-40">
                        ...
                        <h3 class="title">Clean and simple design, <span> <a style="color: black;" href="/login/">Comes</a> with everything you need to get started!</span></h3>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        <div class="services-icon">
                            <img class="shape" src="assetsdemo/images/services-shape.svg" alt="shape">
                            <img class="shape-1" src="assetsdemo/images/services-shape-1.svg" alt="shape">
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="services-icon">
                            <img class="shape" src="assetsdemo/images/services-shape.svg" alt="shape">
                            <img class="shape-1" src="assetsdemo/images/services-shape-2.svg" alt="shape">
                            <i class="lni-cog"></i>
                        </div>
                        <div class="services-content mt-30">
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-services text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        <div class="services-icon">
                            <img class="shape" src="assetsdemo/images/services-shape.svg" alt="shape">
                            <img class="shape-1" src="assetsdemo/images/services-shape-3.svg" alt="shape">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="about-image text-center mt-50 wow fadeInRightBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img src="assetsdemo/images/about1.svg" alt="about">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
        <div class="about-shape-1">
            <img src="assetsdemo/images/about-shape-1.svg" alt="shape">
        </div>
    </section>
    ...
    <section class="about-area pt-70">
        <div class="about-shape-2">
            <img src="assetsdemo/images/about-shape-2.svg" alt="shape">
        </div>
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6 order-lg-first">
                    <div class="about-image text-center mt-50 wow fadeInRightBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img src="assetsdemo/images/about2.svg" alt="about">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
    ...
    <section class="about-area pt-70">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="about-image text-center mt-50 wow fadeInRightBig" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img src="assetsdemo/images/about3.svg" alt="about">
                    </div> <!-- about image -->
                </div>
            </div> <!-- row -->
        </div> <!-- container -->
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="video-content mt-50 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <img class="dots" src="assetsdemo/images/dots.svg" alt="dots">
                        <div class="video-wrapper">
                            <div class="video-image">
                                <img src="assetsdemo/images/video.png" alt="video">
                            </div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        <div class="team-image">
                            <img src="assetsdemo/images/team-1.png" alt="Team">
                            <div class="social">
                                <ul>
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="team-image">
                            <img src="assetsdemo/images/team-2.png" alt="Team">
                            <div class="social">
                                <ul>
                                    <li><a href="#"><i class="lni-facebook-filled"></i></a></li>
                                    <li><a href="#"><i class="lni-twitter-filled"></i></a></li>
                ...
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        <div class="team-image">
                            <img src="assetsdemo/images/team-3.png" alt="Team">
                            <div class="social">
                                <ul>
                                    <li><a href="#"><i class="lni-facebook-filled"></i></a></li>
                                    <li><a href="#"><i class="lni-twitter-filled"></i></a></li>
                    ...
                    <div class="single-testimonial">
                        ...
                        <div class="testimonial-author d-flex align-items-center">
                            <div class="author-image">
                                <img class="shape" src="assetsdemo/images/textimonial-shape.svg" alt="shape">
                                <img class="author" src="assetsdemo/images/author-1.png" alt="author">
                            </div>
                ...
                <div class="col-lg-4">
                    <div class="single-testimonial">
                        ...
                        <div class="testimonial-author d-flex align-items-center">
                            <div class="author-image">
                                <img class="shape" src="assetsdemo/images/textimonial-shape.svg" alt="shape">
                                <img class="author" src="assetsdemo/images/author-2.png" alt="author">
                            </div>
                            <div class="author-content media-body">
                ...
                <div class="col-lg-4">
                    <div class="single-testimonial">
                        ...
                        <div class="testimonial-author d-flex align-items-center">
                            <div class="author-image">
                                <img class="shape" src="assetsdemo/images/textimonial-shape.svg" alt="shape">
                                <img class="author" src="assetsdemo/images/author-3.png" alt="author">
                            </div>
                            <div class="author-content media-body">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7">
                    <div class="single-blog mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        <div class="blog-image">
                            <img src="assetsdemo/images/blog-1.jpg" alt="blog">
                        </div>
                ...
                <div class="col-lg-4 col-md-7">
                    <div class="single-blog mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        <div class="blog-image">
                            <img src="assetsdemo/images/blog-2.jpg" alt="blog">
                        </div>
                        <div class="blog-content">
                            <ul class="meta">
                                <li>Posted By: <a href="#">Admin</a></li>
                ...
                <div class="col-lg-4 col-md-7">
                    <div class="single-blog mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        <div class="blog-image">
                            <img src="assetsdemo/images/blog-3.jpg" alt="blog">
                        </div>
                        <div class="blog-content">
                            <ul class="meta">
                                <li>Posted By: <a href="#">Admin</a></li>
...
-->
    ...
    <!--====== Jquery js ======-->
    <script src="assetsdemo/js/vendor/jquery-1.12.4.min.js"></script>
    <script src="assetsdemo/js/vendor/modernizr-3.7.1.min.js"></script>
    
    <!--====== Bootstrap js ======-->
    <script src="assetsdemo/js/popper.min.js"></script>
    <script src="assetsdemo/js/bootstrap.min.js"></script>
    
    <!--====== Plugins js ======-->
    <script src="assetsdemo/js/plugins.js"></script>
    
    <!--====== Slick js ======-->
    <script src="assetsdemo/js/slick.min.js"></script>
    
    <!--====== Ajax Contact js ======-->
    <script src="assetsdemo/js/ajax-contact.js"></script>
    
    <!--====== Counter Up js ======-->
    <script src="assetsdemo/js/waypoints.min.js"></script>
    <script src="assetsdemo/js/jquery.counterup.min.js"></script>
    
    <!--====== Magnific Popup js ======-->
    <script src="assetsdemo/js/jquery.magnific-popup.min.js"></script>
    
    <!--====== Scrolling Nav js ======-->
    <script src="assetsdemo/js/jquery.easing.min.js"></script>
    <script src="assetsdemo/js/scrolling-nav.js"></script>
    
    <!--====== wow js ======-->
    <script src="assetsdemo/js/wow.min.js"></script>
    
    <!--====== Particles js ======-->
    <script src="assetsdemo/js/particles.min.js"></script>
